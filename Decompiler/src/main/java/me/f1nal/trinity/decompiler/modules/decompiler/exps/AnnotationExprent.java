...
public class AnnotationExprent extends Exprent {
  ...
  public TextBuffer toJava(int indent, BytecodeMappingTracer tracer) {
    ...
    buffer.append('@');
    buffer.append(OutputMemberSerializer.tag(DecompilerContext.getImportCollector().getNestedName(ExprProcessor.buildJavaClassName(className)), l -> new ClassOutputMember(l, className)));
