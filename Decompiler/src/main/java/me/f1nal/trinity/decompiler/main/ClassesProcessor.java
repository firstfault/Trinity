...
import me.f1nal.trinity.decompiler.main.collectors.BytecodeSourceMapper;
...
import me.f1nal.trinity.decompiler.main.rels.NestedMemberAccess;
  ...
  public void writeClass(StructClass cl, TextBuffer buffer) throws IOException {
    ...
    try {
      ...
      if (packageInfo) {
        ...
        buffer.append(OutputMemberSerializer.serializeTags(new PackageOutputMember(0, null, true)));
        buffer.append(OutputMemberSerializer.serializeTags(new PackageOutputMember(0, cl.qualifiedName, false)));
