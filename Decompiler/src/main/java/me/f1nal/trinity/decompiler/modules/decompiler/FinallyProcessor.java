...
import me.f1nal.trinity.decompiler.modules.code.DeadCodeHelper;
...
import me.f1nal.trinity.decompiler.modules.decompiler.sforms.SSAConstructorSparseEx;
import me.f1nal.trinity.decompiler.modules.decompiler.stats.BasicBlockStatement;
import me.f1nal.trinity.decompiler.modules.decompiler.stats.CatchAllStatement;
...
public class FinallyProcessor {
  ...
  private Record getFinallyInformation(StructClass cl, StructMethod mt, RootStatement root, CatchAllStatement fstat) {
    ...
    ExprProcessor proc = new ExprProcessor(methodDescriptor, varProcessor, BytecodeMarkerOutputMember.getHashcode(cl.qualifiedName, mt.getDescriptor(), mt.getName()));
