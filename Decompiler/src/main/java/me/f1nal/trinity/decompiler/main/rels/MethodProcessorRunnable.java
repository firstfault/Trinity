...
import me.f1nal.trinity.decompiler.modules.decompiler.*;
...
import me.f1nal.trinity.decompiler.modules.decompiler.deobfuscator.ExceptionDeobfuscator;
...
public class MethodProcessorRunnable implements Runnable {
  ...
  public static RootStatement codeToJava(StructClass cl, StructMethod mt, MethodDescriptor md, VarProcessor varProc) throws IOException {
    ...
    ExprProcessor proc = new ExprProcessor(md, varProc, BytecodeMarkerOutputMember.getHashcode(cl.qualifiedName, mt.getDescriptor(), mt.getName()));
