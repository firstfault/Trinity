...
import me.f1nal.trinity.decompiler.code.cfg.ControlFlowGraph;
import me.f1nal.trinity.decompiler.code.cfg.ExceptionRangeCFG;
...
import me.f1nal.trinity.decompiler.modules.decompiler.StatEdge.EdgeDirection;
import me.f1nal.trinity.decompiler.modules.decompiler.StatEdge.EdgeType;
import me.f1nal.trinity.decompiler.modules.decompiler.decompose.FastExtendedPostdominanceHelper;
import me.f1nal.trinity.decompiler.modules.decompiler.deobfuscator.IrreducibleCFGDeobfuscator;
import me.f1nal.trinity.decompiler.modules.decompiler.stats.*;
...
public final class DomHelper {
  ...
  public static VBStyleCollection<List<Integer>, Integer> calcPostDominators(Statement container) {
    ...
    HashMap<Statement, FastFixedSetFactory.FastFixedSet<Statement>> lists = new HashMap<>();
    ...
    do {
      ...
      for (Statement stat : lstStats) {
        ...
        FastFixedSetFactory.FastFixedSet<Statement> doms = lists.get(stat);
        ...
        for (int j = 0; j < lstSuccs.size(); j++) {
          ...
          FastFixedSetFactory.FastFixedSet<Statement> succlst = lists.get(succ);
