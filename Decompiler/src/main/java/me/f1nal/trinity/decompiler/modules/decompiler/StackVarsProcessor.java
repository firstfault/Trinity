...
import me.f1nal.trinity.decompiler.modules.decompiler.sforms.*;
import me.f1nal.trinity.decompiler.util.FastSparseSetFactory;
import me.f1nal.trinity.decompiler.util.SFormsFastMapDirect;
import me.f1nal.trinity.decompiler.modules.decompiler.exps.*;
import me.f1nal.trinity.decompiler.modules.decompiler.sforms.*;
import me.f1nal.trinity.decompiler.modules.decompiler.sforms.DirectNode.DirectNodeType;
import me.f1nal.trinity.decompiler.modules.decompiler.stats.DoStatement;
...
import me.f1nal.trinity.decompiler.modules.decompiler.vars.VarVersionEdge;
import me.f1nal.trinity.decompiler.modules.decompiler.vars.VarVersionNode;
import me.f1nal.trinity.decompiler.modules.decompiler.vars.VarVersionPair;
import me.f1nal.trinity.decompiler.modules.decompiler.vars.VarVersionsGraph;
...
public class StackVarsProcessor {
  ...
  private static void replaceSingleVar(Exprent parent, VarExprent var, Exprent dest, SSAUConstructorSparseEx ssau) {
    ...
    for (VarVersionPair varpaar : setVars) {
      ...
      for (Iterator<Entry<Integer, FastSparseSetFactory.FastSparseSet<Integer>>> itent = node.live.entryList().iterator(); itent.hasNext(); ) {
        Entry<Integer, FastSparseSetFactory.FastSparseSet<Integer>> ent = itent.next();
        ...
        if (!livemap.containsKey(key)) {
          ...
          FastSparseSetFactory.FastSparseSet<Integer> set = ent.getValue();
