package me.f1nal.trinity.gui.frames.impl.entryviewer;
...
public abstract class ArchiveEntryViewerWindow<T extends ArchiveEntry> extends ClosableWindow {
    ...
    protected boolean beginWindow() {
        ...
        if (ImGui.isItemHovered() && ImGui.isMouseReleased(1)) {
            ...
            tabPopup.menuItem("Close Others", () -> Main.getDisplayManager().closeAll(wnd -> wnd instanceof ArchiveEntryViewerWindow && wnd != this));
            tabPopup.menuItem("Close All", () -> Main.getDisplayManager().closeAll(wnd -> wnd instanceof ArchiveEntryViewerWindow<?>));
            tabPopup.separator();
