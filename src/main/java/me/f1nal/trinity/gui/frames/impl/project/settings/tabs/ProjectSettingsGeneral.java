...
import me.f1nal.trinity.gui.frames.impl.CreateDatabasePopup;
...
public class ProjectSettingsGeneral extends AbstractProjectSettingsTab {
    ...
    public ProjectSettingsGeneral(Trinity trinity) {
        ...
        this.databasePath = new FileSelectorComponent("Database Path", getDatabase().getPath().getAbsolutePath(), CreateDatabasePopup.TDB_FILE_FILTER, FileDialog.SAVE);
    }
