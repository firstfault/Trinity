package me.f1nal.trinity.gui.frames.impl.constant;
...
import me.f1nal.trinity.gui.frames.impl.constant.search.ConstantSearchTypeNull;
...
public class ConstantSearchFrame extends StaticWindow {
    ...
    protected void renderFrame() {
        ...
        if (ImGui.button("Search")) {
            ...
            Main.getDisplayManager().addClosableWindow(new ConstantViewFrame(trinity, constantList));
